...
import { logout, whoami, gettingAllUsers } from '../../reducers/actions/users'
...
class App extends Component {
  render(){
    console.log("USER IN BIGINNERING", this.props.user)
    return (
    <div>
...
const mapDispatchToProps = dispatch => ({
  ...
  getUser: (history) => () => dispatch(gettingAllUsers(history))
})
